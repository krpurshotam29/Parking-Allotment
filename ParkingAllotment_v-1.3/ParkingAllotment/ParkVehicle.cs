                ...
                switch (int.Parse(choice))
                {
                    case 1:
                        ...
                        while (vehicleType == VehicleType.NONE)
                            parkingSlot = ReadVehicleDetail(out vehicleType);
                        if(parkingLot.GetNumberOfTwoWheelerParked()<TwoWheelerCapacity && parkingLot.GetNumberOfFourWheelerParked()<FourWheelerCapacity && parkingLot.GetNumberOfOtherVehicleParked()<OtherVehicleCapacity){
