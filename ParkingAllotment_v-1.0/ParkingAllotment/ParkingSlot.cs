...
namespace ParkingAllotmentSystem
{
    public class ParkingSlot
    {
        ...
        {
            return (TwoWheelerParkingAreaCapacity - TwoWheelerCount);
        }

        public int GetEmptyFourWheelerSlots()
        {
            return (FourWheelerParkingAreaCapacity - FourWheelerCount);
        }

        public int GetEmptyOtherVehicleSlots()
        {
            return (OtherVehicleParkingAreaCapacity - OtherVehicleCount);
        }
